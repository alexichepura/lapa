...
pub fn read_ext() -> ReadExtStmt {
    ReadExtStmt(crate::client::async_::Stmt::new(
        "SELECT ext FROM \"ContentImage\" WHERE id = $1",
    ))
}
...
pub fn read_by_content() -> ReadByContentStmt {
    ReadByContentStmt(crate::client::async_::Stmt::new(
        "SELECT id, ext FROM \"ContentImage\" WHERE content_id = $1",
    ))
}
pub struct ReadByContentStmt(crate::client::async_::Stmt);
...
pub fn delete_many_by_id() -> DeleteManyByIdStmt {
    DeleteManyByIdStmt(crate::client::async_::Stmt::new(
        "DELETE FROM \"ContentImage\" WHERE id = ANY($1)",
    ))
}
